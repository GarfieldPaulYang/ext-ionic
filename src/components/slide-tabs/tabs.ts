...
export class SlideTabs implements AfterContentInit, AfterViewInit, OnDestroy {
  /**
  ...
  @ContentChildren(SlideTab)
  private superTabs: QueryList<SlideTab>;
  ...
  @ViewChild(SlideTabsToolbar)
  private toolbar: SlideTabsToolbar;
