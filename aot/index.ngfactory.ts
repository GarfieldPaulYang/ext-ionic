...
import * as import36 from './src/components/open-url-modal/open-url-modal-component.ngfactory';
...
class WhcyitModuleInjector extends import0.NgModuleInjector<import1.WhcyitModule> {
  ...
  _WhcyitModule_8:import1.WhcyitModule;
  __LOCALE_ID_9:any;
  ...
  constructor(parent:import27.Injector) {
    super(parent,[
      ...
      import35.ToastCmpNgFactory,
      import36.OpenUrlModalCmpNgFactory
    ]
    ,([] as any[]));
  }
  ...
  get _EventManager_21():import15.EventManager {
    if ((this.__EventManager_21 == null)) { (this.__EventManager_21 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_20,this.parent.get(import40.NgZone))); }
  ...
  get _RootRenderer_25():any {
    if ((this.__RootRenderer_25 == null)) { (this.__RootRenderer_25 = import41._createConditionalRootRenderer(this._DomRootRenderer_24,this.parent.get(import41.NgProbeToken,(null as any)))); }
  ...
  get _BrowserXhr_33():import21.BrowserXhr {
    if ((this.__BrowserXhr_33 == null)) { (this.__BrowserXhr_33 = new import21.BrowserXhr()); }
    return this.__BrowserXhr_33;
  }
  get _ResponseOptions_34():import22.BaseResponseOptions {
    if ((this.__ResponseOptions_34 == null)) { (this.__ResponseOptions_34 = new import22.BaseResponseOptions()); }
    return this.__ResponseOptions_34;
  }
  get _XSRFStrategy_35():any {
    if ((this.__XSRFStrategy_35 == null)) { (this.__XSRFStrategy_35 = import5._createDefaultCookieXSRFStrategy()); }
    return this.__XSRFStrategy_35;
  }
  get _XHRBackend_36():import23.XHRBackend {
    if ((this.__XHRBackend_36 == null)) { (this.__XHRBackend_36 = new import23.XHRBackend(this._BrowserXhr_33,this._ResponseOptions_34,this._XSRFStrategy_35)); }
  ...
  get _Http_38():any {
    if ((this.__Http_38 == null)) { (this.__Http_38 = import5.httpFactory(this._XHRBackend_36,this._RequestOptions_37)); }
    return this.__Http_38;
  }
  get _RadioControlRegistry_39():import25.RadioControlRegistry {
    if ((this.__RadioControlRegistry_39 == null)) { (this.__RadioControlRegistry_39 = new import25.RadioControlRegistry()); }
  ...
  createInternal():import1.WhcyitModule {
    ...
    this._WhcyitModule_8 = new import1.WhcyitModule();
    ...
    this._ApplicationRef__14 = new import12.ApplicationRef_(this.parent.get(import40.NgZone),this.parent.get(import42.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_12,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_13);
    return this._WhcyitModule_8;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.WhcyitModule)) { return this._WhcyitModule_8; }
    if ((token === import43.LOCALE_ID)) { return this._LOCALE_ID_9; }
    ...
    if ((token === import49.IterableDiffers)) { return this._IterableDiffers_29; }
    if ((token === import50.KeyValueDiffers)) { return this._KeyValueDiffers_30; }
...
export const WhcyitModuleNgFactory:import0.NgModuleFactory<import1.WhcyitModule> = new import0.NgModuleFactory(WhcyitModuleInjector,import1.WhcyitModule);